const vegetables = [
    ...
    { id: "broccoli", name: "Broccoli", seeds: 1, method: "Freeze", yield: "1.0", type: "bags" },
    { id: "cabbage", name: "Cabbage", seeds: 1, method: "Ferment", yield: "1.0", type: "jars" },
    { id: "cauliflower", name: "Cauliflower", seeds: 1, method: "Freeze", yield: "1.0", type: "bags" },
    { id: "lettuce", name: "Lettuce", seeds: 4, method: "Eat fresh", yield: "1-1.5 lbs", type: "Fresh Produce" },
    { id: "spinach", name: "Spinach", seeds: 9, method: "Freeze", yield: "0.5", type: "bags" },
    { id: "kale", name: "Kale", seeds: 1, method: "Freeze", yield: "1.0", type: "bags" },
    { id: "peas", name: "Peas", seeds: 9, method: "Freeze", yield: "0.5", type: "bags" },
    ...
    { id: "corn", name: "Sweet corn", seeds: 4, method: "Freeze", yield: "0.5-1.0", type: "bags" },
    ...
    { id: "zucchini", name: "Zucchini squash", seeds: 1, method: "Freeze", yield: "2.0", type: "bags" },
    { id: "peppers", name: "Bell peppers", seeds: 1, method: "Freeze", yield: "1.0-2.0", type: "bags" },
    { id: "eggplant", name: "Eggplant", seeds: 1, method: "Freeze", yield: "1.0-2.0", type: "bags" },
